...
public class TokensController extends BaseController {
     ...
     * @return    Returns the TokensResponse response from the API call 
     */
    public TokensResponse createToken(
            ...
            public void run() {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            TokensResponse returnValue = _handleCreateTokenResponse(_context);
     ...
     * @return An object of type TokensResponse
     */
    private TokensResponse _handleCreateTokenResponse(HttpContext _context)
        ...
        TokensResponse _result = APIHelper.deserialize(_responseBody,
                                                        new TypeReference<TokensResponse>(){});
     ...
     * @return    Returns the TokensResponse response from the API call 
     */
    public TokensResponse getToken(
                final String id,
                final String publicKey,
                final String appId
    ) throws Throwable {
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            TokensResponse returnValue = _handleGetTokenResponse(_context);
                            callBack.onSuccess(_context, returnValue);
                        } catch (Exception e) {
                            callBack.onFailure(_context, e);
                        }
     ...
     * @return An object of type TokensResponse
     */
    private TokensResponse _handleGetTokenResponse(HttpContext _context)
            throws APIException, IOException {
        HttpResponse _response = _context.getResponse();
